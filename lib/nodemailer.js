        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="order-details">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value"><span class="status-badge" style="background: #ffd700; color: #000;">${orderDetails.selectedSize || 'Not specified'}</span></span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Selected Color:</span>
                        <span class="detail-value"><span class="status-badge" style="background: #ffd700; color: #000;">${orderDetails.selectedColor || 'Not specified'}</span></span>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">${orderDetails.customerInfo?.firstName || 'Not provided'} ${orderDetails.customerInfo?.lastName || ''}</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Customer Email:</span>
                        <span class="detail-value">${orderDetails.customerInfo?.email || 'Not provided'}</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Phone Number:</span>
                        <span class="detail-value">${orderDetails.customerInfo?.phone || 'Not provided'}</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Street Address:</span>
                        <span class="detail-value">${orderDetails.customerInfo?.address || 'Not provided'}</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">City:</span>
                        <span class="detail-value">${orderDetails.customerInfo?.city || 'Not provided'}</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">State:</span>
                        <span class="detail-value">${orderDetails.customerInfo?.state || 'Not provided'}</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Postal Code:</span>
                        <span class="detail-value">${orderDetails.customerInfo?.zipCode || 'Not provided'}</span>
                    </div>
                    <div class="detail-row">
            ...
            <div class="footer">
                <p class="footer-text">
                    ...
                    <strong>Customer Service:</strong> If you have any questions about this order, contact us at ${process.env.BUSINESS_EMAIL || 'limitedrepsbusiness@gmail.com'}<br>
  ...
  customerConfirmation: (orderDetails) => {
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <div class="greeting">
                    Thank you for your purchase, ${orderDetails.customerInfo?.firstName || 'Valued Customer'}!
                </div>
                ...
                <div class="order-details">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">${orderDetails.selectedSize || 'Not specified'}</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Color:</span>
                        <span class="detail-value">${orderDetails.selectedColor || 'Not specified'}</span>
                    </div>
                    <div class="detail-row">
                ...
                <div class="order-details">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">${orderDetails.customerInfo?.firstName || ''} ${orderDetails.customerInfo?.lastName || ''}</span>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">${orderDetails.customerInfo?.city || ''}, ${orderDetails.customerInfo?.state || ''} ${orderDetails.customerInfo?.zipCode || ''}</span>
                    </div>
                </div>
                ...
                <div class="next-steps">
                    ...
                    <ul>
                        ...
                        <li>If you have any questions, contact us at ${process.env.BUSINESS_EMAIL || 'limitedrepsbusiness@gmail.com'}</li>
                    </ul>
                </div>
...
export const sendOrderNotification = async (orderDetails) => {
  const businessEmail = 'mudassirshahid605@gmail.com'
...
export const sendCustomerConfirmation = async (orderDetails) => {
  const customerEmail = orderDetails.customerInfo?.email || orderDetails.customerEmail
  if (!customerEmail) {
