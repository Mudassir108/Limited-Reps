...
function detectProductType(category, name) {
  // Check for clothing in name (highest priority - includes socks as clothing)
  if (name.includes('hoodie') || name.includes('shirt') || name.includes('pants') || 
      ...
      name.includes('cardigan') || name.includes('hoodie') || name.includes('shirt') ||
      name.includes('pants') || name.includes('shorts') || name.includes('jacket') ||
      name.includes('jeans') || name.includes('trousers')) {
    return 'clothes'
  }
  ...
  // Check for accessories in name (bags, caps, purses, watches, jewelry, chains, perfumes, AirPods, toys, etc.)
  if (name.includes('bag') || name.includes('cap') || name.includes('hat') ||
      ...
      name.includes('necklace') || name.includes('chain') || name.includes('ring') ||
      name.includes('earring') || name.includes('pendant') || name.includes('perfume') ||
      ...
      name.includes('cable') || name.includes('phone')) {
    return 'accessories'
  }
