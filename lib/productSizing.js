...
function detectProductType(category, name) {
  ...
  // Check for shoes (highest priority after rings and pillows)
  ...
  if ((name.includes('shoe') || name.includes('sneaker') || name.includes('jordan') || 
      ...
      !name.includes('airpod') && !name.includes('airpods') && !name.includes('headphone') &&
      !name.includes('headphones') && !name.includes('speaker') && !name.includes('charger') &&
      !name.includes('cable') && !name.includes('phone') && !name.includes('apple') &&
      !name.includes('sony') && !name.includes('bose') && !name.includes('sennheiser')) {
    return 'shoes'
  }
  
  // Check for pillows (colors only, no sizes)
  ...
  if (name.includes('bag') || name.includes('cap') || name.includes('hat') ||
      ...
      name.includes('versace') || name.includes('gucci') || name.includes('prada') || name.includes('hermes') ||
      ...
      name.includes('blanket') || name.includes('towel') || name.includes('bedding') ||
      name.includes('home') || name.includes('decor')) {
    return 'accessories'
  }
